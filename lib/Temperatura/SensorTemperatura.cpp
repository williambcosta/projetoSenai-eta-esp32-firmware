 ...
 *
 * Cada instancia de SensorTemperatura terá sua propria referencia de OneWire. Isso não é necessário, porém caso
 * um dos sensores se desconectar o indice do mesmo será alterado, o que forçaria a implementação de uma
 * lógica de setup do endereço unico do sensor.
 *
 * Colocando cada sensor em um pino diferente facilita a implementação.
 *
